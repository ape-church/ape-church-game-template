...
export const myGame: Game = {
    ...
    gameBackground: "/my-game-assets/background.png",
    // animatedBackground: "/my-game-assets/animated-background.mp4",
    card: "/my-game-assets/card.png", // 1:1 aspect ratio (e.g. 512x512)
    banner: "/my-game-assets/banner.png", // 2:1 aspect ratio (e.g. 1024x512)
    advanceToNextStateAsset: "/my-game-assets/advance-button.png",
    themeColorBackground: "#F54927",
    // song: "/my-game-assets/audio/my-game-song.wav",
    payouts: {
        0: {
